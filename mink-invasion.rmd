...
As well as the two mink, other carnivore species with similar ranges include the [red fox](https://en.wikipedia.org/wiki/Red_fox) and
[European badger](https://en.wikipedia.org/wiki/European_badger). We will include these species in the model to make it more realistic, but taking
account of the difference in niches which should mean that they interact less with the species of interest.
