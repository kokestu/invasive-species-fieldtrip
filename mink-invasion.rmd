...
We will include these species in the model to make it more realistic. It is possible to adjust the model below to take
...
We assume all species make *universal trade-offs* (see [Tilman 2011](https://www.journals.uchicago.edu/doi/10.1086/661245)).
