...
run_simulation <- function(
        ...
        for (t in 1:n_steps) {
                ...
                results[t + 1, 1] <- t * d   # Add the timestamp
        }
        return(results)
}
```
...
term that represents per-capita mortality of the mink. Both species have a lifespan of approximately 10 years, so the per-capita mortality
rate is $m = \frac{1}{10} = 0.1$.
...
representing colonisation of new territories, and the second part representing loss of territory due to death or displacement.